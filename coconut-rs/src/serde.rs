...
use crate::{Base58, PublicKey, VerificationKey, };
...
impl_serde!(SecretKey, B58SecretKey);
impl_serde!(VerificationKey, B58VerificationKey);
impl_serde!(PublicKey, B58PublicKey);
impl_serde!(PrivateKey, B58PrivateKey);
